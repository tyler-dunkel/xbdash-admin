...
var PackageNpm = function () {
  function PackageNpm() {
    _classCallCheck(this, PackageNpm);
  ...
  PackageNpm.prototype.depends = function depends(dependencies) {
    ...
    if ((typeof dependencies === "undefined" ? "undefined" : _typeof(dependencies)) !== 'object') {
      buildmessage.error("the argument to Npm.depends should be an " + "object, like this: {gcd: '0.0.0'}", { useMyCaller: true });
      // recover by ignoring the Npm.depends line
      return;
    }
  ...
  PackageNpm.prototype.strip = function strip(discards) {
    this._discards.merge(discards);
  };

  PackageNpm.prototype.require = function require(name) {
    try {
