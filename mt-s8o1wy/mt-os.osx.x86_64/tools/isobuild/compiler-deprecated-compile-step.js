...
var convertSourceMapPaths = function convertSourceMapPaths(sourcemap, f) {
  if (!sourcemap) {
...
exports.makeCompileStep = function (sourceItem, file, inputSourceArch, options) {
  ...
  var _addAsset = options.addAsset;
  ...
  var compileStep = {
     ...
     */
    archMatches: function archMatches(pattern) {
    ...
    _getOption: function _getOption(name, options) {
     ...
     * @instance
     */
    addHtml: function addHtml(options) {
     ...
     * @deprecated in 0.9.4
     */
    appendDocument: function appendDocument(options) {
     ...
     * @instance
     */
    addStylesheet: function addStylesheet(options) {
      if (!archinfo.matches(inputSourceArch.arch, "web")) {
     ...
     * @instance
     */
    addJavaScript: function addJavaScript(options) {
      if (typeof options.data !== "string") {
        throw new Error("'data' option to addJavaScript must be a string");
      }

      var sourcePath = this.inputPath;
     ...
     * @instance
     */
    addAsset: function addAsset(options) {
      ...
      _addAsset(options.data, files.convertToStandardPath(options.path, true));
    },
    ...
    error: function error(options) {
      ...
      var message = options.message || "error building " + relPath;

      var info = { file: sourcePath };
