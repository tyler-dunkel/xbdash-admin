var _classCallCheck;module.import('babel-runtime/helpers/classCallCheck',{"default":function(v){_classCallCheck=v}});var isString,isFunction;module.import('underscore',{"isString":function(v){isString=v},"isFunction":function(v){isFunction=v}});var WatchSet;module.import('../fs/watch.js',{"WatchSet":function(v){WatchSet=v}});
...
var SourceArch = function SourceArch(pkg, _ref) {
  var kind = _ref.kind;
  var arch = _ref.arch;
  var sourceRoot = _ref.sourceRoot;
  var getFiles = _ref.getFiles;
  var _ref$uses = _ref.uses;
  var uses = _ref$uses === undefined ? [] : _ref$uses;
  var _ref$implies = _ref.implies;
  var implies = _ref$implies === undefined ? [] : _ref$implies;
  var _ref$declaredExports = _ref.declaredExports;
  var declaredExports = _ref$declaredExports === undefined ? null : _ref$declaredExports;
  var _ref$watchSet = _ref.watchSet;
  var watchSet = _ref$watchSet === undefined ? new WatchSet() : _ref$watchSet;

  _classCallCheck(this, SourceArch);
...
module.export("default",exports.default=(SourceArch));
