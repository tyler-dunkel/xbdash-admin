module.export({WatchSet:function(){return WatchSet},readFile:function(){return readFile},sha1:function(){return sha1},readDirectory:function(){return readDirectory},Watcher:function(){return Watcher},isUpToDate:function(){return isUpToDate},readAndWatchDirectory:function(){return readAndWatchDirectory},readAndWatchFileWithHash:function(){return readAndWatchFileWithHash},readAndWatchFile:function(){return readAndWatchFile}});var _classCallCheck;module.import('babel-runtime/helpers/classCallCheck',{"default":function(v){_classCallCheck=v}});var files;module.import('./files.js',{"default":function(v){files=v}});var _;module.import("underscore",{"default":function(v){_=v}});var safeWatcher={};module.import('./safe-watcher.js',{"*":function(v,n){safeWatcher[n]=v}});var createHash;module.import("crypto",{"createHash":function(v){createHash=v}});var coalesce;module.import('../utils/func-utils.js',{"coalesce":function(v){coalesce=v}});var Profile;module.import('../tool-env/profile.js',{"Profile":function(v){Profile=v}});var optimisticStatOrNull,optimisticReaddir,optimisticHashOrNull;module.import("./optimistic.js",{"optimisticStatOrNull":function(v){optimisticStatOrNull=v},"optimisticReaddir":function(v){optimisticReaddir=v},"optimisticHashOrNull":function(v){optimisticHashOrNull=v}});
...
var WatchSet = function () {
  ...
  WatchSet.prototype.addFile = function addFile(filePath, hash) {
    var self = this;
  ...
  WatchSet.prototype.addDirectory = function addDirectory(_ref) {
    var absPath = _ref.absPath;
    var include = _ref.include;
    var exclude = _ref.exclude;
    var names = _ref.names;
    var unsortedContents = _ref.contents;
    ...
    var contents = _.clone(unsortedContents);
    if (contents) {
      contents.sort();
    }

    self.directories.push({ absPath: absPath, include: include, exclude: exclude, names: names, contents: contents });
  };
  ...
  WatchSet.prototype.merge = function merge(other) {
    var self = this;
    if (self.alwaysFire) {
      return;
    }
  ...
  WatchSet.prototype.clone = function clone() {
    var self = this;
  ...
  WatchSet.prototype.toJSON = function toJSON() {
    var self = this;
    if (self.alwaysFire) {
    ...
    var reToJSON = function reToJSON(r) {
      var options = '';
      if (r.ignoreCase) {
        options += 'i';
      }
  ...
  WatchSet.fromJSON = function fromJSON(json) {
    ...
    var reFromJSON = function reFromJSON(j) {
      if (_.has(j, '$regex')) {
...
function readDirectory(_ref2) {
  ...
  _.each(contents, function (entry) {
    ...
    var stat = files.statOrNull(files.pathJoin(absPath, entry));
    if (!stat) {
...
var Watcher = function () {
  ...
  Watcher.prototype._fireIfFileChanged = function _fireIfFileChanged(absPath) {
    var self = this;
  ...
  Watcher.prototype._fireIfDirectoryChanged = function _fireIfDirectoryChanged(info) {
    var self = this;
  ...
  Watcher.prototype._startFileWatches = function _startFileWatches() {
    var self = this;
  ...
  Watcher.prototype._watchFileOrDirectory = function _watchFileOrDirectory(absPath) {
    var self = this;
  ...
  Watcher.prototype._makeWatchEventCallback = function _makeWatchEventCallback(absPath) {
    var self = this;
    ...
    return coalesce(100, function onWatchEvent() {
      ...
      if (stat === null || stat.isFile()) {
        ...
        _.some(self.watchSet.directories, function (info) {
          return self.stopped || absPath === info.absPath && self._fireIfDirectoryChanged(info, true);
          // XXX #3335 We probably should check again in a second, due to low
          // filesystem modtime resolution.
        });
      }
  ...
  Watcher.prototype._mustNotExist = function _mustNotExist(absPath) {
  ...
  Watcher.prototype._mustBeAFile = function _mustBeAFile(absPath) {
    var wsFiles = this.watchSet.files;
    if (_.has(wsFiles, absPath)) {
  ...
  Watcher.prototype._updateStatForWatch = function _updateStatForWatch(absPath) {
    var self = this;
    var entry = self.watches[absPath];
  ...
  Watcher.prototype._checkDirectories = function _checkDirectories() {
    var self = this;
  ...
  Watcher.prototype._fire = function _fire() {
    var self = this;
...
function isUpToDate(watchSet) {
  return Profile.time('watch.isUpToDate', function () {
    var upToDate = true;
