...
_.extend(Progress.prototype, {
  ...
  reportProgressDone: function reportProgressDone() {
    var self = this;
  ...
  addChildTask: function addChildTask(options) {
    var self = this;
  ...
  dump: function dump(stream, options, prefix) {
    var self = this;
  ...
  reportProgress: function reportProgress(state) {
    var self = this;
  ...
  _notifyState: function _notifyState() {
    var self = this;
  ...
  _updateTotalState: function _updateTotalState() {
    var self = this;
  ...
  _reportChildState: function _reportChildState(child, state) {
    var self = this;
