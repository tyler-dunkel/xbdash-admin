...
var Runner = function () {
  function Runner(_ref) {
    ...
    var appPort = _ref.appPort;
    var banner = _ref.banner;
    var disableOplog = _ref.disableOplog;
    var cordovaRunner = _ref.cordovaRunner;
    var mongoUrl = _ref.mongoUrl;
    var onFailure = _ref.onFailure;
    var oplogUrl = _ref.oplogUrl;
    var projectContext = _ref.projectContext;
    var proxyHost = _ref.proxyHost;
    var proxyPort = _ref.proxyPort;
    var quiet = _ref.quiet;
    var rootUrl = _ref.rootUrl;
    var selenium = _ref.selenium;
    var seleniumBrowser = _ref.seleniumBrowser;
    var noReleaseCheck = _ref.noReleaseCheck;

    var optionsForAppRunner = _objectWithoutProperties(_ref, ['appHost', 'appPort', 'banner', 'disableOplog', 'cordovaRunner', 'mongoUrl', 'onFailure', 'oplogUrl', 'projectContext', 'proxyHost', 'proxyPort', 'quiet', 'rootUrl', 'selenium', 'seleniumBrowser', 'noReleaseCheck']);
    ...
    var mongoPort = parseInt(listenPort, 10) + 1;
  ...
  Runner.prototype._startMongoAsync = function _startMongoAsync() {
    return _regeneratorRuntime.async(function _startMongoAsync$(_context) {
      while (1) {
  ...
  Runner.prototype.regenerateAppPort = function regenerateAppPort() {
    var self = this;
...
exports.run = function (options) {
  ...
  var buildMode = runOptions.buildOptions.buildMode;
