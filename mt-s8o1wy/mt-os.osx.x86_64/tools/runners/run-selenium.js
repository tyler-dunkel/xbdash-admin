...
var Selenium = function Selenium(options) {
  var self = this;
  options = options || {};
...
_.extend(Selenium.prototype, {
  ...
  _gotState: function _gotState(state) {
    var self = this;
  ...
  _gotMagicLog: function _gotMagicLog(facility, msg) {
    var self = this;
  ...
  _pollLogsOnce: function _pollLogsOnce() {
    var self = this;
