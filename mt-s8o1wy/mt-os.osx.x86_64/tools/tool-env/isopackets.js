module.export({ISOPACKETS:function(){return ISOPACKETS},load:function(){return load},ensureIsopacketsLoadable:function(){return ensureIsopacketsLoadable},makeIsopacketBuildContext:function(){return makeIsopacketBuildContext}});var Builder;module.import('../isobuild/builder.js',{"default":function(v){Builder=v}});var assert = require('assert');
...
var ISOPACKETS = {
  ...
  'cordova-support': ['boilerplate-generator', 'logging', 'webapp-hashing', 'xmlbuilder'],
  'logging': ['logging'],
...
var isopacketPath = function isopacketPath(isopacketName) {
...
var newIsopacketBuildingCatalog = function newIsopacketBuildingCatalog() {
  if (!files.inCheckout()) {
...
var loadIsopacketFromDisk = function loadIsopacketFromDisk(isopacketName) {
  var image = bundler.readJsImage(files.pathJoin(isopacketPath(isopacketName), 'program.json'));
...
module.export("default",exports.default=(exports));
