...
var RequireInvocation = function RequireInvocation(name, filename) {
  var self = this;
...
exports.printReport = function () {
  ...
  var computeTimes = function computeTimes(inv) {
  ...
  var summary = {};
  var summarize = function summarize(inv, depth) {
