module.export({parse:function(){return parse},markBottom:function(){return markBottom},markTop:function(){return markTop}});var _ = require('underscore');
...
function parse(err) {
  ...
  return {
    insideFiber: insideFiber,
    outsideFiber: outsideFiber
  };
}
