...
var matches = function matches(host, program) {
...
var mostSpecificMatch = function mostSpecificMatch(host, programs) {
  var seen = {};
  var best = null;
...
// exception.
var leastSpecificDescription = function leastSpecificDescription(programs) {
...
var withoutSpecificOs = function withoutSpecificOs(arch) {
