module.export({updateMeteorToolSymlink:function(){return updateMeteorToolSymlink}});var _ = require('underscore');
...
var checkForUpdate = function checkForUpdate(showBanner, printErrors) {
...
var shouldShow = function shouldShow(key, maxAge) {
  var now = +new Date();
...
var maybeShowBanners = function maybeShowBanners() {
