...
var Db = function Db(dbFile, options) {
  var self = this;
...
_.extend(Db.prototype, {
  ...
  // TODO: Move to utils?
  _retry: function _retry(f, options) {
  ...
  _serialize: function _serialize(f) {
    var self = this;
  ...
  // This yields.
  closePermanently: function closePermanently() {
    var self = this;
  ...
  runInTransaction: function runInTransaction(action) {
    var self = this;
  ...
  _query: function _query(sql, params) {
    ...
    var rows = new Promise(function (resolve, reject) {
  ...
  // Hidden to enforce transaction usage
  _execute: function _execute(sql, params) {
    var self = this;
  ...
  _prepareWithCache: function _prepareWithCache(sql) {
    var self = this;
  ...
  _closePreparedStatements: function _closePreparedStatements() {
    var self = this;
...
var Table = function Table(name, jsonFields, options) {
  var self = this;
  options = options || {};
...
_.extend(Table.prototype, {
  _buildStatements: function _buildStatements() {
    var self = this;
  ...
  // mark.
  _generateQuestionMarks: function _generateQuestionMarks(n) {
    return "(" + _.times(n, function () {
      return "?";
    }).join(",") + ")";
  },

  find: function find(txn, id) {
    var self = this;
  ...
  upsert: function upsert(txn, objects) {
    var self = this;
  ...
  createTable: function createTable(txn) {
    var self = this;
...
var RemoteCatalog = function RemoteCatalog() {
  var self = this;
...
_.extend(RemoteCatalog.prototype, {
  ...
  getLatestVersion: function getLatestVersion(name) {
    var self = this;
  ...
  getSortedVersions: function getSortedVersions(name) {
    var self = this;
  ...
  // trip to sqlite.
  getSortedVersionRecords: function getSortedVersionRecords(name) {
    var self = this;
  ...
  getLatestMainlineVersion: function getLatestMainlineVersion(name) {
    var self = this;
    var versions = self.getSortedVersions(name);
    versions.reverse();
  ...
  getPackage: function getPackage(name, options) {
  ...
  getAllBuilds: function getAllBuilds(name, version) {
  ...
  getBuildsForArches: function getBuildsForArches(name, version, arches) {
    var self = this;
  ...
  getReleaseTrack: function getReleaseTrack(name) {
    var self = this;
  ...
  getReleaseVersion: function getReleaseVersion(track, version) {
    var self = this;
  ...
  forceRecommendRelease: function forceRecommendRelease(track, version) {
    var self = this;
  ...
  getAllReleaseTracks: function getAllReleaseTracks() {
    return _.pluck(this._columnsQuery("SELECT name FROM releaseTracks"), 'name');
  },

  getAllPackageNames: function getAllPackageNames() {
  ...
  initialize: function initialize(options) {
    ...
    self.tableBannersShown = new Table('bannersShown', ['_id', 'lastShown'], { noContentColumn: true });
  ...
  getSortedRecommendedReleaseVersions: function getSortedRecommendedReleaseVersions(track, laterThanOrderKey) {
    var self = this;
  ...
  getSortedRecommendedReleaseRecords: function getSortedRecommendedReleaseRecords(track, laterThanOrderKey) {
    var self = this;
  ...
  getReleaseVersionRecords: function getReleaseVersionRecords(track) {
    var self = this;
    var result = self._contentQuery("SELECT content FROM releaseVersions WHERE track=?", track);
    return result;
  },
  ...
  // track.
  getNumReleaseVersions: function getNumReleaseVersions(track) {
    var self = this;
  ...
  // given release track.
  getDefaultReleaseVersion: function getDefaultReleaseVersion(track) {
    var self = this;
  ...
  // given release track.
  getDefaultReleaseVersionRecord: function getDefaultReleaseVersionRecord(track) {
    var self = this;
  ...
  getBuildWithPreciseBuildArchitectures: function getBuildWithPreciseBuildArchitectures(versionRecord, buildArchitectures) {
    var self = this;
  ...
  _contentQuery: function _contentQuery(query, params) {
    var self = this;
  ...
  _columnsQuery: function _columnsQuery(query, params) {
    var self = this;
  ...
  _insertReleaseVersions: function _insertReleaseVersions(releaseVersions) {
    var self = this;
    return self.db.runInTransaction(function (txn) {
  ...
  insertData: function insertData(serverData, syncComplete) {
    var self = this;
    return self.db.runInTransaction(function (txn) {
  ...
  _setMetadata: function _setMetadata(txn, key, value) {
    var self = this;
    value._id = key;
    self.tableMetadata.upsert(txn, [value]);
  },

  shouldShowBanner: function shouldShowBanner(releaseName, bannerDate) {
    var self = this;
    var row = self.db.runInTransaction(function (txn) {
  ...
  setBannerShownDate: function setBannerShownDate(releaseName, bannerShownDate) {
    var self = this;
    self.db.runInTransaction(function (txn) {
