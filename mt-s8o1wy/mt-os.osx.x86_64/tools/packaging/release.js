...
var Release = function Release(options) {
  var self = this;
...
_.extend(Release.prototype, {
  ...
  isProperRelease: function isProperRelease() {
  ...
  getReleaseTrack: function getReleaseTrack() {
    var self = this;
  ...
  getReleaseVersion: function getReleaseVersion() {
    var self = this;
    if (!self.isProperRelease()) {
      throw new Error("not a proper release?");
    }
  ...
  getToolsPackage: function getToolsPackage() {
    var self = this;
  ...
  // uses. Valid only for proper releases.
  getToolsVersion: function getToolsVersion() {
    var self = this;
  ...
  getToolsPackageAtVersion: function getToolsPackageAtVersion() {
    var self = this;
  ...
  getCurrentToolsVersion: function getCurrentToolsVersion() {
    var self = this;
  ...
  getCatalogReleaseData: function getCatalogReleaseData() {
    var self = this;
    if (!self.isProperRelease()) {
      throw new Error("not a proper release?");
    }
  ...
  getDisplayName: function getDisplayName(options) {
    var self = this;
