var isIsobuildFeaturePackage;module.import('../isobuild/compiler.js',{"isIsobuildFeaturePackage":function(v){isIsobuildFeaturePackage=v}});var _ = require('underscore');
...
exports.PackageMap = function (versions, options) {
  ...
  _.each(versions, function (version, packageName) {
    ...
    if (packageSource) {
      self._map[packageName] = { kind: 'local', version: version, packageSource: packageSource };
    } else {
      self._map[packageName] = { kind: 'versioned', version: version, packageSource: null };
    }
  });
};

_.extend(exports.PackageMap.prototype, {
  eachPackage: function eachPackage(iterator) {
    var self = this;
  ...
  getInfo: function getInfo(packageName) {
    var self = this;
  ...
  makeSubsetMap: function makeSubsetMap(packageNames) {
    var self = this;
    var subsetVersions = {};
  ...
  toVersionMap: function toVersionMap() {
    var self = this;
    var ret = {};
    _.each(self._map, function (info, packageName) {
  ...
  isSupersetOfJSON: function isSupersetOfJSON(mapJSON) {
    var self = this;
...
_.extend(exports.PackageMapDelta.prototype, {
  _storeAddOrChange: function _storeAddOrChange(packageName, newInfo, oldVersion, anticipatedPrereleases, neededToUseUnanticipatedPrereleases) {
    var self = this;
  ...
  _storeRemove: function _storeRemove(packageName, oldVersion) {
    var self = this;
    self._changedPackages[packageName] = {
      oldVersion: oldVersion,
      newVersion: null
  ...
  eachChangedPackage: function eachChangedPackage(iterator) {
    var self = this;
  ...
  displayOnConsole: function displayOnConsole(options) {
    var self = this;
    options = _.extend({
